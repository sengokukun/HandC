...
$.extend($.validator, {
	...
	messages: {
		...
		hankaku: "Please enter a valid hankaku.",
		bigletter: "Please enter a valid big letter.",
	...
	classRuleSettings: {
		...
		dateDE: {dateDE: true},
		number: {number: true},
		hankaku: {hankaku: true},
		bigletter: {bigletter: true},
	...
	methods: {
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/bigletter
		bigletter: function(value, element) {
